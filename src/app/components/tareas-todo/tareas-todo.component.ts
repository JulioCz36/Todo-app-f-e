...
@Component({
  selector: 'app-tareas-todo',
  templateUrl: './tareas-todo.component.html',
  styleUrls: ['./tareas-todo.component.css']
})
export class TareasTodoComponent implements OnInit {
  ...
  getTareasList(): void {
    this.tareasListService.getTareas().subscribe((tareasList) => {
      this.tareasList = tareasList.slice();
